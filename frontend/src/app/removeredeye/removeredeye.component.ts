...
@Component({
  selector: 'app-removeredeye',
  templateUrl: './removeredeye.component.html',
  styleUrls: ['./removeredeye.component.scss']
})
export class RemoveredeyeComponent {
  ...
  onFileSelected(event: any) {
    ...
    if (this.file != null) {
      ...
      this.imageSrc = 'assets/img/dummy-logo.png';
      this.cd.detectChanges();
      this.onUpload_remove_red_eye();
    }
  }

  async onUpload_remove_red_eye() {
    if (!this.file) {
      ...
      this.http
        .get('http://localhost:5000/get_remove_red_eyes', {
          responseType: 'blob',
